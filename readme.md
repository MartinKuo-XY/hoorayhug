...
<p><img src="https://raw.githubusercontent.com/zhboner/hoorayhug/master/assets/hoorayhug.png"/></p>

[![hoorayhug](https://github.com/MartinKuo-XY/hoorayhug/workflows/ci/badge.svg)](https://github.com/MartinKuo-XY/hoorayhug/actions)
[![hoorayhug](https://github.com/MartinKuo-XY/hoorayhug/workflows/build/badge.svg)](https://github.com/MartinKuo-XY/hoorayhug/actions/workflows/cross_compile.yml)
[![downloads](https://img.shields.io/github/downloads/zhboner/hoorayhug/total?color=green)](https://github.com/MartinKuo-XY/hoorayhug/releases)
<!-- [中文说明](https://zhb.me/hoorayhug) -->

## Libs

| lib | doc |
| ----- | ----- |
| hoorayhug-core | [![crates.io](https://img.shields.io/crates/v/hoorayhug_core.svg)](https://crates.io/crates/hoorayhug_core) [![Released API docs](https://docs.rs/hoorayhug_core/badge.svg)](https://docs.rs/hoorayhug_core) |
| hoorayhug-io | [![crates.io](https://img.shields.io/crates/v/hoorayhug_io.svg)](https://crates.io/crates/hoorayhug_io) [![Released API docs](https://docs.rs/hoorayhug_io/badge.svg)](https://docs.rs/hoorayhug_io) |
| hoorayhug-lb | [![crates.io](https://img.shields.io/crates/v/hoorayhug_lb.svg)](https://crates.io/crates/hoorayhug_lb) [![Released API docs](https://docs.rs/hoorayhug_lb/badge.svg)](https://docs.rs/hoorayhug_lb) |
| hoorayhug-hook | [![crates.io](https://img.shields.io/crates/v/hoorayhug_hook.svg)](https://crates.io/crates/hoorayhug_hook) [![Released API docs](https://docs.rs/hoorayhug_hook/badge.svg)](https://docs.rs/hoorayhug_hook)|
| hoorayhug-syscall | [![crates.io](https://img.shields.io/crates/v/hoorayhug_syscall.svg)](https://crates.io/crates/hoorayhug_syscall) [![Released API docs](https://docs.rs/hoorayhug_syscall/badge.svg)](https://docs.rs/hoorayhug_syscall) |
...
hoorayhug can be run in a container with OCI (like Docker, Podman, Kubernetes, etc), see guides [here](readme.container.md).
...
```shell
git clone https://github.com/MartinKuo-XY/hoorayhug && cd hoorayhug
```
...
The `hoorayhug` binary will be available in `target/release`.
...
- brutal-shutdown: see [hoorayhug_io/brutal-shutdown](hoorayhug_io/README.md#about-brutal-shutdown).
- hook: see [hoorayhug_hook](hoorayhug_hook/README.md).
...
```shell
hoorayhug -l 0.0.0.0:5000 -r 1.1.1.1:443
```
...
```shell
# use toml
hoorayhug -c config.toml

# use json
hoorayhug -c config.json
...
```shell
hoorayhug_CONF='{"endpoints":[{"local":"127.0.0.1:5000","remote":"1.1.1.1:443"}]}' hoorayhug

# or
export hoorayhug_CONF=`cat config.json | jq -c `
hoorayhug
```
...
Available algorithms (provided by [hoorayhug_lb](./hoorayhug_lb/)):
...
- stdout
- stderr
- path (e.g. `/var/log/hoorayhug.log`)
